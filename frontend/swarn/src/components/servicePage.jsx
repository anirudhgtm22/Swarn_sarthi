...
//       try {
//         const response = await fetch('http://127.0.0.1:8000/services/services/'); // Replace with your actual API endpoint
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
//         const data = await response.json();
//         // Filter out 'created_at' field for cleaner data
...
//   return (
//     <div className={{ padding: '2rem' }}> {/* Add some padding for better presentation */}
...
//                 </Typography>
//               </CardContent>
//               <CardActions style={{ display: 'flex', justifyContent: 'space-between' }}> {/* Center the buttons horizontally */}
...
//   return (
//     <div style={{ padding: '2rem' }}> {/* Add some padding for better presentation */}
//       <Typography variant="h4" gutterBottom>
//         Services offered
//       </Typography>
//       <Grid container spacing={3}>
//         {services.map((service) => (
//           <Grid item xs={12} sm={6} md={4} key={service.id}>
//             <Card style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)' }}>
//               <CardContent>
//                 <Typography variant="h5" component="h2">
//                   {service.title}
//                 </Typography>
...
//               </CardContent>
//               <CardActions style={{ display: 'flex', justifyContent: 'space-between' }}> {/* Center the buttons horizontally */}
//                 <Button style={{ color: '#fff', backgroundColor: '#1976d2', '&:hover': { backgroundColor: '#115293' } }} size="small">Know more</Button>
//                 <Button style={{ color: '#fff', backgroundColor: '#1976d2', '&:hover': { backgroundColor: '#115293' } }} size="small">Book now</Button>
//               </CardActions>
//             </Card>
//           </Grid>
//         ))}
...
//                 </Typography>
//               </CardContent>
//               <CardActions style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem', borderTop: '1px solid #f0f0f0' }}> {/* Center the buttons horizontally */}
...
//     const fetchData = async () => {
//       try {
//         const response = await fetch('http://127.0.0.1:8000/services/services/');
//         if (!response.ok) {
//           throw new Error('Network response was not ok');
//         }
//         const data = await response.json();
